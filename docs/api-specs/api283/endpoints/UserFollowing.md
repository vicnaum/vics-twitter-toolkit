...
```typescript
// Root: UserFollowingResponse
interface UserFollowingResponse {
  data: UserFollowingResponseData;
}

interface UserFollowingResponseData {
  user_result_by_rest_id: UserFollowingResponseDataUserResultByRestId;
}

interface UserFollowingResponseDataUserResultByRestId {
  rest_id: string;
  result: User;
}
...
interface User {
  __typename: string;
  following_timeline: UserFollowingTimeline;
  rest_id: string;
}

interface UserFollowingTimeline {
  id: string;
  timeline: UserFollowingTimelineTimeline;
}

interface UserFollowingTimelineTimeline {
  id: string;
...
interface TimelineClearCacheItemEntriesItem {
  content: TimelineTimelineItem;  // 72/72
  entry_id: string;  // 72/72
  sort_index: string;  // 72/72
}
  ...
  "data": {
    "user_result_by_rest_id": {
      ...
      "result": {
        ...
        "rest_id": "951329744804392960",
        "following_timeline": {
          "id": "VGltZWxpbmU6CgAFDTPNXM9UMAAA",
          "timeline": {
            "id": "FollowingProduct-Timeline",
            "instructions": [
              {
                ...
                "entries": [
                  {
                    "content": {
                      ...
                      "cursor_type": "Bottom",
                      "value": "1791348759821472019|1769498571029086136"
                    },
                    "entry_id": "user-2327407569",
                    "sort_index": "1769498571029086208"
                  },
                  {
                    "content": {
                      "__typename": "TimelineTimelineItem",
