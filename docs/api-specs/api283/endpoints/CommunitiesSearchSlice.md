...
**Route:** `GET /CommunitiesSearchSlice`
...
```typescript
// Root: CommunitySearchResponse
interface CommunitySearchResponse {
  data: CommunitySearchResponseData;
}

interface CommunitySearchResponseData {
  communities_search_slice: CommunitySearchResponseDataCommunitiesSearchSlice;
}

interface CommunitySearchResponseDataCommunitiesSearchSlice {
  items_results: CommunitySearchResponseDataCommunitiesSearchSliceItemsResultsItem[];
  slice_info: CommunitySearchResponseDataCommunitiesSearchSliceSliceInfo;
}

interface CommunitySearchResponseDataCommunitiesSearchSliceItemsResultsItem {
  rest_id: string;  // 10/10
  result: Community;  // 10/10
}
...
interface CommunityNotificationSettingsItem {
  notification_setting?: string;  // 20/2
  notification_type?: string;  // 20/2
}

interface CommunityRulesItem {
  description?: string;  // 17/9
  name?: string;  // 50/9
  rest_id?: string;  // 50/9
}
...
interface CommunitySearchResponseDataCommunitiesSearchSliceSliceInfo {
  next_cursor: string;
}
...
```json
{
  "data": {
    "communities_search_slice": {
      "items_results": [
        {
          ...
          "result": {
            ...
            "viewer_relationship": {
              "id": "VXNlckNvbW11bml0eVJlbGF0aW9uc2hpcDoKAAEWEzIlIJegAgoAAhTbepYcFHACAA==",
              "moderation_state": {
      ...
      "slice_info": {
        "next_cursor": "WzI5MC4xMTMzNywxODU2NDg2NTMwMDU2OTI5NDI3XQ=="
      }
    }
  }
}
