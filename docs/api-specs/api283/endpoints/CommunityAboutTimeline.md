# Community AboutTimeline

**Route:** `GET /CommunityAboutTimeline`
**API:** `twitter283.p.rapidapi.com`
**Description:** Community AboutTimeline
...
```typescript
// Root: CommunityAboutTimelineResponse
interface CommunityAboutTimelineResponse {
  data: CommunityAboutTimelineResponseData;
}

interface CommunityAboutTimelineResponseData {
  community_by_rest_id: CommunityAboutTimelineResponseDataCommunityByRestId;
}

interface CommunityAboutTimelineResponseDataCommunityByRestId {
  community_media_timeline: CommunityAboutTimelineResponseDataCommunityByRestIdCommunityMediaTimeline;
  rest_id: string;
}

interface CommunityAboutTimelineResponseDataCommunityByRestIdCommunityMediaTimeline {
  id: string;
  timeline: CommunityAboutTimelineResponseDataCommunityByRestIdCommunityMediaTimelineTimeline;
}

interface CommunityAboutTimelineResponseDataCommunityByRestIdCommunityMediaTimelineTimeline {
  id: string;
  instructions: TimelineClearCacheItem[];
  metadata: CommunityAboutTimelineResponseDataCommunityByRestIdCommunityMediaTimelineTimelineMetadata;
}
...
interface CommunityAboutTimelineResponseDataCommunityByRestIdCommunityMediaTimelineTimelineMetadata {
  scribe_config: CommunityAboutTimelineResponseDataCommunityByRestIdCommunityMediaTimelineTimelineMetadataScribeConfig;
}

interface CommunityAboutTimelineResponseDataCommunityByRestIdCommunityMediaTimelineTimelineMetadataScribeConfig {
  page: string;
}
              ...
              "entries": [
                {
                  "content": {
                    ...
                    "content": {
                      ...
                      "tweet_results": {
                        "rest_id": "1923725260941087126",
                        "result": {
                          "__typename": "TweetWithVisibilityResults",
                          "tweet": {
                            "author_community_relationship": {
                              "id": "VXNlckNvbW11bml0eVJlbGF0aW9uc2hpcDoKAAEaZsKxklrAAAoAAhTbepYcFHACAA==",
                              "role": "Member"
                            },
                            ...
                            "core": {
                              "user_results": {
                                "rest_id": "1902421960531034112",
                                "result": {
                                  "__typename": "User",
                                  "action_counts": {
                                    "favorites_count": 2098
                                  },
                                  "avatar": {
                                    "image_url": "https://pbs.twimg.com/profile_images/1913155089847480320/0q_B2vbJ_normal.jpg"
                                  },
                                  "banner": {
                                    "image_url": "https://pbs.twimg.com/profile_banners/1902421960531034112/1744967027"
                                  },
                                  "core": {
                                    "created_at": "Wed Mar 19 18:09:00 +0000 2025",
                                    "name": "Hub",
                                    "screen_name": "_News_hub_"
                                  },
                                  "dm_permissions": {
                                    "can_dm": false
                                  },
                                  ...
                                  "profile_bio": {
                                    "description": "Taza #News | Tez #Politics | Junooni #Cricket | Trending #Comedy | Knowledge #Crypto | All In 1 #Hub",
                                    "entities": {
                                      "description": {
                                        "hashtags": [
                                          "...",
                            ...
                            "edit_control": {
                              ...
                              "editable_until_msecs": "1747490417000",
                              "is_edit_eligible": true,
                              "edits_remaining": "5"
                            },
                            "legacy": {
                              "bookmark_count": 0,
                              "conversation_id_str": "1923725260941087126",
                              "created_at": "Sat May 17 13:00:17 +0000 2025",
                              "display_text_range": [
                                0,
                                0
                              ],
                              ...
                              "extended_entities": {
                                "media": [
                                  {
                                    "display_url": "pic.twitter.com/1GayRmNzT6",
                                    "expanded_url": "https://twitter.com/_News_hub_/status/1923725260941087126/photo/1",
                                    ...
                                    "id_str": "1923725252133068800",
                                    "indices": [
                                      279,
                                      279
                                    ],
                                    "media_key": "3_1923725252133068800",
                                    "media_results": {
                                      "id": "QXBpTWVkaWFSZXN1bHRzOgwAAQoAARqyceyq1yAACgACGrJx7rfW0ZYAAA==",
                                      "result": {
                                        "__typename": "ApiMedia",
                                        "id": "QXBpTWVkaWE6DAABCgABGrJx7KrXIAAKAAIasnHut9bRlgAA",
                                        "media_key": "3_1923725252133068800"
                                      }
                                    },
                                    "media_url_https": "https://pbs.twimg.com/media/GrJx7KrXIAAf6dV.jpg",
                                    "original_info": {
                                      "focus_rects": [
                                        {
                                          "h": "...",
                              ...
                              "favorite_count": 2,
                              "full_text": "🚨Bitcoin Dominance is Climbing Again!\n\nIt's approaching a critical resistance level near 64.85%.\n\nChances are high $BTC...",
                              "lang": "en",
                              "possibly_sensitive_editable": true,
                              "quote_count": 0,
                              "reply_count": 0,
                              "retweet_count": 1,
                              "user_id_str": "1902421960531034112",
                            ...
                            "note_tweet": {
                              "note_tweet_results": {
                                "rest_id": "1923725260844666880",
                                "result": {
                                  "__typename": "NoteTweet",
                                  "rest_id": "1923725260844666880",
                                  "text": "🚨Bitcoin Dominance is Climbing Again!\n\nIt's approaching a critical resistance level near 64.85%.\n\nChances are high $BTC...",
                                  "entity_set": {
                                    "hashtags": [
                                      {
                                        "indices": [
                            ...
                            "rest_id": "1923725260941087126",
                            "unmention_data": {
                              "id": "VW5tZW50aW9uczoKAAEasnHut9bRlg8AAgoAAAAAAA=="
                            },
                            "view_count_info": {
                              "count": "80",
                    ...
                    "cursor_type": "Top",
                    "value": "DAABCgABGrKH6WJAJxEKAAIasnHut9bRlggAAwAAAAEAAA"
                  },
                  "entry_id": "tweet-1923725260941087126",
                  "sort_index": "1923749427286114304"
                },
                {
                  "content": {
                    "__typename": "TimelineTimelineItem",
