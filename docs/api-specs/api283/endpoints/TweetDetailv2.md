# Tweet Detail Light V2

**Route:** `GET /TweetDetailv2`
**API:** `twitter283.p.rapidapi.com`
**Description:** Tweet Detail Light V2
...
```typescript
// Root: TweetDetailLightV2Response
interface TweetDetailLightV2Response {
  data: TweetDetailLightV2ResponseData;
}

interface TweetDetailLightV2ResponseData {
  tweetResult: TweetDetailLightV2ResponseDataTweetResult;
}

interface TweetDetailLightV2ResponseDataTweetResult {
  result: Tweet;
}
